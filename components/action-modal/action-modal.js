...
function ActionModal(props) {
    ...
    console.log("Props action" + data)
    if (props.action.actionType == "slider") {
        return (
    ...
    else if(props.action.actionType == "endEffector"){
        return (
            <div className={classes.coordsContainer}>
                ...
                <div className={classes.divider}></div>
                <div className={classes.actionType}> <span style={{ fontWeight: '600', fontSize: '14px'}}>Action Type:</span> <span style={{fontSize: '14px'}}>End Effector</span></div>
                <div className={classes.coords}>
                    <div className={classes.angle}>
                        <p className={classes.jointLabel}>X:</p> <p className={classes.value}>{props.action.action.val1}</p>
                    </div>
                    <div className={classes.angle}>
                        <p className={classes.jointLabel}>Y:</p> <p className={classes.value}>{props.action.action.val2}</p>
                    </div>
                    <div className={classes.angle}>
                        <p className={classes.jointLabel}>Z:</p> <p className={classes.value}>{props.action.action.val3}</p>
                    </div>
                </div>
            </div>
        );
