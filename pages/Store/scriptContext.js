...
export function ScriptContextProvider(props) {
  ...
  useEffect(() => {
    ...
    if (delayAction != null) {
      setActions([...actions, delayAction]);
    }
  }, [delayAction]);
  ...
  useEffect(() => {
    ...
    if (sliderAction != null) {
      setActions([...actions, sliderAction]);
    }
  }, [sliderAction]);
  ...
  useEffect(() => {
    ...
    if (coordAction != null) {
      setActions([...actions, coordAction]);
    }
  }, [coordAction]);
  ...
  function addSliderAction(sliderData) {
    ...
    let data = {
      ...
      action: {
        val1: sliderData.servo1,
        val2: sliderData.servo2,
        val3: sliderData.servo3,
        val4: sliderData.servo4,
        val5: sliderData.servo5,
      },
    };
